...
{/* Pending logs */}
  export interface PendingLogSummary {
  totalWorkingDays: number;
  totalUniqueLoggedDays: number;
  maxPendingDaysAcrossProjects: number;
  totalProjectsWithLogs: number;
  dateRange: {
    from: string;
    to: string;
  };
...
export interface ProjectPendingLogs {
  projectId: string;
  projectName: string;
  pendingDates: string[];
...
export interface MyPendingLogsResponse {
  summary: PendingLogSummary;
  projectsPendingLogs: ProjectPendingLogs[];
  message: string;
}
